...
from be_task_ca.database import Base, engine

# just importing all the models is enough to have them created
from be_task_ca.item.infra.models import ItemModel  # noqa: F401
from be_task_ca.user.infra.models import CartItemModel, UserModel  # noqa: F401
